...
namespace LearningArchive.Example
{
	public class AssetBundleExample : MonoBehaviour
	{
...
#if UNITY_EDITOR
		[UnityEditor.MenuItem("LearningArchive/Example/011.AssetBundleExample/Build AssetBundle", false, 11)]
		...
		[UnityEditor.MenuItem("LearningArchive/Example/011.AssetBundleExample/Run", false, 11)]
